    ...
    <main className="bg-zinc-950 min-h-screen pt-32 pb-20 text-gray-300">
      ...
      <section className="max-w-6xl mx-auto px-6 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 p-6 rounded-xl flex flex-col items-center text-center hover:bg-zinc-900/60 transition-colors">
            <div className="w-12 h-12 rounded-full bg-sky-500/10 flex items-center justify-center text-sky-400 mb-4">
              <svg
            ...
            <p className="text-sm text-zinc-400">
              Até <strong className="text-white">7 dias corridos</strong> após o
              recebimento para devolver e receber o reembolso total.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 p-6 rounded-xl flex flex-col items-center text-center hover:bg-zinc-900/60 transition-colors">
            ...
            <p className="text-sm text-zinc-400">
              ...
              <strong className="text-white">nossa conta</strong> (frete de
              envio grátis).
            </p>
          </div>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 p-6 rounded-xl flex flex-col items-center text-center hover:bg-zinc-900/60 transition-colors">
            ...
            <p className="text-sm text-zinc-400">
              Garantia de <strong className="text-white">90 dias</strong> contra
              qualquer defeito de fabricação ou costura.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 space-y-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-zinc-400 leading-relaxed">
            ...
            <strong className="text-white">atendimento@urbanflex.com.br</strong>{" "}
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside pl-2 space-y-1 text-zinc-500">
            <li>
              <strong className="text-zinc-300">Cartão de Crédito:</strong> O
              estorno poderá ocorrer em até duas faturas subsequentes.
            </li>
            <li>
              <strong className="text-zinc-300">PIX ou Boleto:</strong> Depósito
              em conta corrente em até 5 dias úteis após a análise do produto.
            </li>
          </ul>
        </div>
      </section>
