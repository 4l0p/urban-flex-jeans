...
// Interface mantida para compatibilidade com o page.tsx
interface HeroProps {
  price: number;
}

export default function Hero({ price }: HeroProps) {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center bg-zinc-950">
      ...
      <div className="relative z-50 text-center px-4 max-w-4xl mx-auto">
        ...
        {/* --- BOTÕES: Layout original restaurado --- */}
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <button
            ...
            className="border border-white/30 text-white px-8 py-4 rounded-full font-bold text-sm tracking-widest hover:bg-white/10 transition-all backdrop-blur-sm cursor-pointer"
          >
            VER O VÍDEO
          </button>
        </div>
